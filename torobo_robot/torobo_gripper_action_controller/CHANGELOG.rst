...
* Therefore, roboticsgroup_gazebo_plugin's mimic_joint function is not needed.

Edited by Hiroyuki Oka, Tokyo Robotics Inc. (2018-11-07)
-------------------
* Use copy smart pointer of rt_active_goal_ in The function checkForSuccess() of gripper_action_controller_impl.h in order to avoid crash when preempting.
* Add prefix of "torobo" to filename, namespace and classname.
