...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsNotSelfColliding_1) // Zero Position
{
...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsNotSelfColliding_2) // Home Position
{
    torobo_msgs::CheckCollision::Request req;
    torobo_msgs::CheckCollision::Response res;
...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsNotSelfColliding_3)
{
    torobo_msgs::CheckCollision::Request req;
    torobo_msgs::CheckCollision::Response res;
...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsSelfColliding_1)
{
    torobo_msgs::CheckCollision::Request req;
    torobo_msgs::CheckCollision::Response res;
...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsNotSelfColliding_4)
{
    torobo_msgs::CheckCollision::Request req;
    torobo_msgs::CheckCollision::Response res;
...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsSelfColliding_2)
{
    torobo_msgs::CheckCollision::Request req;
    torobo_msgs::CheckCollision::Response res;
...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsNotSelfColliding_5)
{
    torobo_msgs::CheckCollision::Request req;
    torobo_msgs::CheckCollision::Response res;
...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsNotSelfColliding_6)
{
    torobo_msgs::CheckCollision::Request req;
    torobo_msgs::CheckCollision::Response res;
...
TEST_F(ToroboCollisionDetectorTest, Humanoid16_Gripper_CheckIsNotSelfColliding_7)
{
    torobo_msgs::CheckCollision::Request req;
    torobo_msgs::CheckCollision::Response res;
    ...
    req.jointState.name = joint_names_;
    req.jointState.position = vector<double>(joint_names_.size(), 0.0);
#if 1   // 干渉検出メッシュ作成方法変更により104degあたりから干渉するようになったため条件を修正 // 2019/3/8 sato
    req.jointState.position[5] = angles::from_degrees(103.0);  // max of joint_6
#else
    req.jointState.position[5] = angles::from_degrees(105.0);  // max of joint_6
#endif
    check_collision_service_client_.call(req, res);
